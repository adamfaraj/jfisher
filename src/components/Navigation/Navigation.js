...
export default function Navigation() {
  ...
  return (
    <Navbar collapseOnSelect expand="lg" variant="dark" fixed="top" style={{ transition: 'top 0.3s', top: show ? '0' : '-65px' }}>
      <Container>
        <Navbar.Brand onClick={scrollToTop}>Jourdain Fisher</Navbar.Brand>
